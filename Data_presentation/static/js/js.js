...
$(function () {
    ...
    function echarts_21() {
        ...
        function makeAjaxRequest2() {
            $.ajax({
                ...
                dataType: "JSON",
                success: function (res) {
                    option.yAxis[0].data = [res.data[0].type, res.data[1].type, res.data[2].type, res.data[3].type, res.data[4].type]
                    option.series[0].data = [res.data[0].value, res.data[1].value, res.data[2].value, res.data[3].value, res.data[4].value]
                    option.series[1].data = [res.data[0].value + 50, res.data[1].value + 50, res.data[2].value + 50, res.data[3].value + 50, res.data[4].value + 50]
                    // 使用刚指定的配置项和数据显示图表。
                    myChart.setOption(option);
                }
            });
    ...
    function echarts_3() {
        ...
        var keywords = [{"name": "C.C.", "value": 2.64},
            {"name": "C.C.", "value": 4.03},
